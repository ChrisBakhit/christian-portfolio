    ...
    <main className={sidebarOpen ? "sidebarOpen" : undefined} onClick={() => activeMenu && setActiveMenu(null)}>
      ...
      <section className="about section" id="about">
        ...
        <article className="profileDocument" data-reveal>
          <p className="codeComment">// who I am · what I build · what I&apos;m focused on</p>
          <div className="profileIntro"><figure className="realPhoto"><img src="/christian-profile.webp" alt="Christian Bakhit at Washington Square Park" /><figcaption><span>christian-profile.webp</span><small>New York, NY</small></figcaption></figure><div><h3>About Me</h3><p>Hi, I&apos;m <strong>Christian Bakhit</strong>, a full-stack engineer working across <strong>product development</strong>, <strong>cloud systems</strong>, and <strong>applied AI</strong>. I build software that is useful, reliable, and clear enough for both technical and non-technical teams to trust.</p><p>At Supercharge, I develop patent-intelligence and portfolio-strategy products using React, REST APIs, AWS services, data systems, and large language models.</p></div></div>
          <div className="focusSection"><span className="profileLabel">Current Focus</span><div className="focusGrid"><div><i>01</i><p>Building production patent-intelligence and portfolio-analysis tools</p></div><div><i>02</i><p>Designing responsive React interfaces and dependable REST APIs</p></div><div><i>03</i><p>Developing AWS Lambda and DynamoDB serverless workflows</p></div><div><i>04</i><p>Applying LLMs to evidence-backed professional workflows</p></div><div><i>05</i><p>Continuing graduate study through Georgia Tech OMSCS</p></div><div><i>06</i><p>Shipping community and service-oriented platforms outside of work</p></div></div></div>
          <div className="profileEducation"><span className="profileLabel">Education</span><div className="educationCards"><article><small>2025 — 2027</small><h4>Georgia Institute of Technology</h4><p>M.S. Computer Science · OMSCS</p></article><article><small>2020 — 2024</small><h4>Johns Hopkins University</h4><p>B.S. Computer Science · Applied Mathematics &amp; Statistics</p></article></div></div>
        </article>
      </section>
