  ...
  return (
    <main className={sidebarOpen ? "sidebarOpen" : undefined} onClick={() => activeMenu && setActiveMenu(null)}>
      ...
      <section className="educationFile section" id="education">
        ...
        <div className="blackHoleScene" aria-hidden="true"><span className="accretionDisk" /><span className="blackHole"><i /></span><span className="orbitPath orbitA"><i /></span><span className="orbitPath orbitB"><i /></span><span className="gravityLabel">education / gravity well</span></div>
